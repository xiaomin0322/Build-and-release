...
import sun.org.mozilla.classfile.internal.*;
import java.util.*;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "sun.org.mozilla.javascript.internal.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("sun/org/mozilla/javascript/internal/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "sun/org/mozilla/javascript/internal/BaseFunction",
                      "createObject",
                      "(Lsun/org/mozilla/javascript/internal/Context;"
                      +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                      +")Lsun/org/mozilla/javascript/internal/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "sun/org/mozilla/javascript/internal/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "sun/org/mozilla/javascript/internal/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "sun/org/mozilla/javascript/internal/ScriptRuntime",
                      "hasTopCall",
                      "(Lsun/org/mozilla/javascript/internal/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "sun/org/mozilla/javascript/internal/ScriptRuntime",
                      "doTopCall",
                      "(Lsun/org/mozilla/javascript/internal/Callable;"
                      +"Lsun/org/mozilla/javascript/internal/Context;"
                      +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                      +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lsun/org/mozilla/javascript/internal/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "sun/org/mozilla/javascript/internal/NativeFunction",
                      "initScriptFunction",
                      "(Lsun/org/mozilla/javascript/internal/Context;"
                      +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "sun/org/mozilla/javascript/internal/RegExpProxy",
                              "compileRegExp",
                              "(Lsun/org/mozilla/javascript/internal/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lsun/org/mozilla/javascript/internal/Context;"
                      +")Lsun/org/mozilla/javascript/internal/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "sun/org/mozilla/javascript/internal/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "sun/org/mozilla/javascript/internal/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Lsun/org/mozilla/javascript/internal/Context;"
                  +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                  +"Lsun/org/mozilla/javascript/internal/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lsun/org/mozilla/javascript/internal/Scriptable;"
          +"Lsun/org/mozilla/javascript/internal/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lsun/org/mozilla/javascript/internal/NativeFunction;"
                               +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lsun/org/mozilla/javascript/internal/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lsun/org/mozilla/javascript/internal/NativeFunction;"
                               +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                               +"Lsun/org/mozilla/javascript/internal/Scriptable;II"
                               +")Lsun/org/mozilla/javascript/internal/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lsun/org/mozilla/javascript/internal/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "sun/org/mozilla/javascript/internal/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lsun/org/mozilla/javascript/internal/Context;"
                    +")Lsun/org/mozilla/javascript/internal/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lsun/org/mozilla/javascript/internal/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                            +"Lsun/org/mozilla/javascript/internal/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lsun/org/mozilla/javascript/internal/Callable;"
                            +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                            +"Lsun/org/mozilla/javascript/internal/Context;"
                            +"Lsun/org/mozilla/javascript/internal/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "sun/org/mozilla/javascript/internal/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "sun/org/mozilla/javascript/internal/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "sun/org/mozilla/javascript/internal/EcmaError";
