...
/**
 * Exception thrown by
 * {@link sun.org.mozilla.javascript.internal.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link sun.org.mozilla.javascript.internal.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link sun.org.mozilla.javascript.internal.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link sun.org.mozilla.javascript.internal.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link sun.org.mozilla.javascript.internal.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link sun.org.mozilla.javascript.internal.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link sun.org.mozilla.javascript.internal.Context#resumeContinuation(Object, Scriptable, Object)}.
