...
public class Context
{
    ...
    // JDK change: avoid caching timezone, localTZA etc. in NativeDate
    // static fields - instead fetch these from the current context.
    private java.util.TimeZone thisContextTimeZone;
    private double LocalTZA;
    public void setTimeZone() {
        thisContextTimeZone =  java.util.TimeZone.getDefault();
    }
    public java.util.TimeZone getTimeZone() {
        return thisContextTimeZone;
    }
    public void setLocalTZA() {
        LocalTZA = thisContextTimeZone.getRawOffset();
    }
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(sun.org.mozilla.javascript.internal.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "sun.org.mozilla.javascript.internal.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "sun.org.mozilla.javascript.internal.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(sun.org.mozilla.javascript.internal.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see sun.org.mozilla.javascript.internal.ErrorReporter
     */
     ...
     * @see sun.org.mozilla.javascript.internal.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (sun.org.mozilla.javascript.internal.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see sun.org.mozilla.javascript.internal.Script
     */
     ...
     * @see sun.org.mozilla.javascript.internal.Function
     */
    ...
    public final ClassLoader getApplicationClassLoader()
    {
        if (applicationClassLoader == null) {
            ...
            if (loader == null) {
                ...
                // JDK change: No need to check if the thread context
                // loader can "see" Rhino classes -- because rhino classes
                // are loaded by bootstrap loader. Besides, from an untrusted
                // applet loader, we can't "see" sun.* classes and hence
                // we will get false result.  This was:
                //
                // if (threadLoader != null
                //    && Kit.testIfCanLoadRhinoClasses(threadLoader))
                //
                // removed Kit.testIfCanLoadRhinoClasses check.
    ...
    public final void setApplicationClassLoader(ClassLoader loader)
    {
        ...
        // JDK change: No need to check if any loader can "see"
        // rhino classes as these are bootstrap classes. This was:
        //
    ...
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "sun.org.mozilla.javascript.internal.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "sun.org.mozilla.javascript.internal.regexp.RegExpImpl");
            if (cl != null) {
