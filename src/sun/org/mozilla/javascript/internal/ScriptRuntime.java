...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("sun.org.mozilla.javascript.internal.Context"),
        ContextFactoryClass
            = Kit.classOrNull("sun.org.mozilla.javascript.internal.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("sun.org.mozilla.javascript.internal.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("sun.org.mozilla.javascript.internal.ScriptableObject");
    public static final Class<Scriptable> ScriptableClass =
        Scriptable.class;

    private static final String[] lazilyNames = {
        "RegExp",        "sun.org.mozilla.javascript.internal.regexp.NativeRegExp",
        "Packages",      "sun.org.mozilla.javascript.internal.NativeJavaTopPackage",
        "java",          "sun.org.mozilla.javascript.internal.NativeJavaTopPackage",
        "javax",         "sun.org.mozilla.javascript.internal.NativeJavaTopPackage",
        ...
        "JavaAdapter",   "sun.org.mozilla.javascript.internal.JavaAdapter",
        "JavaImporter",  "sun.org.mozilla.javascript.internal.ImporterTopLevel",
        "Continuation",  "sun.org.mozilla.javascript.internal.NativeContinuation",
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "sun.org.mozilla.javascript.internal.tools.shell.Global";
    ...
    private static class DefaultMessageProvider implements MessageProvider {
        public String getMessage(String messageId, Object[] arguments) {
            final String defaultResource
                = "sun.org.mozilla.javascript.internal.resources.Messages";
            ...
            // Now, getting the resource bundle under do privileged
            // Without do privileged, under security manager error messages
            // can not be loaded.
            ResourceBundle rb = AccessController.doPrivileged(
                new PrivilegedAction<ResourceBundle>() {
                    public ResourceBundle run() {
                        return ResourceBundle.getBundle(defaultResource, locale);
                    }
                });
