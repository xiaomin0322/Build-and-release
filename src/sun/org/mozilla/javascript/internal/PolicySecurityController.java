...
import sun.org.mozilla.classfile.internal.ByteCode;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lsun/org/mozilla/javascript/internal/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "sun/org/mozilla/javascript/internal/Callable", "call",
                "(" + callableCallSig);
