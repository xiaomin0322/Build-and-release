...
public class Delegator implements Function {
     ...
     *
     * @see sun.org.mozilla.javascript.internal.Delegator#construct
     */
    public Delegator() {
    }
     ...
     * @see sun.org.mozilla.javascript.internal.Scriptable
     */
    ...
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#get(int, Scriptable)
     */
    public Object get(int index, Scriptable start) {
        return obj.get(index,start);
        }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#has(String, Scriptable)
     */
    public boolean has(String name, Scriptable start) {
        return obj.has(name,start);
        }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#has(int, Scriptable)
     */
    public boolean has(int index, Scriptable start) {
        return obj.has(index,start);
        }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#put(String, Scriptable, Object)
     */
    public void put(String name, Scriptable start, Object value) {
        obj.put(name,start,value);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#getIds
     */
     ...
     *
     * @see sun.org.mozilla.javascript.internal.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see sun.org.mozilla.javascript.internal.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see sun.org.mozilla.javascript.internal.Function#call
     */
